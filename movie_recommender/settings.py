...
SECRET_KEY = "django-insecure-hw(vm!x#0*^g9(953i02nv$evkw1*8sks=h-c^&ojuq1f_g4+g"
...
# Secure your app
ALLOWED_HOSTS = ['movie-recommender-theasurus.herokuapp.com']
